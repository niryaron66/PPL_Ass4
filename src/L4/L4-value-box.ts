...
import {CExp, isPrimOp, PrimOp, VarDecl, unparse, ProcExp, LetExp} from './L4-ast';
...
export const makeTracedClosure = (closure: Closure, name: string): TracedClosure => ({tag: "TracedClosure", name, closure,counter : makeBox(0)})
